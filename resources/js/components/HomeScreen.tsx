      ...
      <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8 md:p-12">
        ...
        <div className="grid gap-6 md:gap-8">
          ...
          <button
            ...
            className="group relative bg-gradient-to-r from-slate-700 to-slate-900 hover:from-slate-800 hover:to-black text-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
          >
            <div className="flex items-center justify-between">
              <div className="text-left flex-1">
                <h2 className="text-3xl font-bold mb-2">Rubo</h2>
